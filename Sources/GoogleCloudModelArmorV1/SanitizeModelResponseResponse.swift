...
public struct SanitizeModelResponseResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = SanitizeModelResponseResponse().with { $0.sanitizationResult = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.modelarmor.v1.SanitizeModelResponseResponse"
  }
