...
public enum StreamingMode: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    ...
    case .buffered: return "STREAMING_MODE_BUFFERED"
    case .realtime: return "STREAMING_MODE_REALTIME"
  ...
  public init(stringValue: Swift.String) {
    ...
    case "STREAMING_MODE_BUFFERED": self = .buffered
    case "STREAMING_MODE_REALTIME": self = .realtime
  ...
  public init(intValue: Int) {
    ...
    case 1: self = .buffered
    case 2: self = .realtime
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .buffered: return try container.encode("STREAMING_MODE_BUFFERED")
    case .realtime: return try container.encode("STREAMING_MODE_REALTIME")
