...
public struct PiAndJailbreakFilterSettings: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Optional. Tells whether Prompt injection and Jailbreak filter is enabled or
  /// disabled.
  public var filterEnforcement: PiAndJailbreakFilterSettings.PiAndJailbreakFilterEnforcement =
  ...
  ///
  /// ```
  /// let value = PiAndJailbreakFilterSettings().with { $0.filterEnforcement = ... }
  /// ```
  ...
  public enum PiAndJailbreakFilterEnforcement: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "PI_AND_JAILBREAK_FILTER_ENFORCEMENT_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:PiAndJailbreakFilterEnforcement/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "PI_AND_JAILBREAK_FILTER_ENFORCEMENT_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:PiAndJailbreakFilterEnforcement/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified:
        return try container.encode("PI_AND_JAILBREAK_FILTER_ENFORCEMENT_UNSPECIFIED")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.modelarmor.v1.PiAndJailbreakFilterSettings"
  }
