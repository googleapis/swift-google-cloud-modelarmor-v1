...
extension Clients {
  ...
  class ModelArmorTransport: ModelArmorStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://modelarmor.googleapis.com")
    }
    ...
    public func listTemplates(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudModelArmorV1.ListTemplatesResponse.self, from: data)
    }
    ...
    public func getTemplate(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudModelArmorV1.Template.self, from: data)
    }
    ...
    public func getFloorSetting(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudModelArmorV1.FloorSetting.self, from: data)
    }
    ...
    public func sanitizeUserPrompt(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudModelArmorV1.SanitizeUserPromptResponse.self, from: data)
    }
    ...
    public func sanitizeModelResponse(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudModelArmorV1.SanitizeModelResponseResponse.self, from: data)
    }
