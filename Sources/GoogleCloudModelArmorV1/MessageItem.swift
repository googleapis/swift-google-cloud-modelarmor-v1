...
public struct MessageItem: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Type of message.
  public var messageType: MessageItem.MessageType = MessageItem.MessageType()
  ...
  /// Initialize a new instance of `MessageItem`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MessageItem().with { $0.messageType = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(MessageItem.MessageType.self, forKey: .messageType)
    {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.modelarmor.v1.MessageItem"
  }
