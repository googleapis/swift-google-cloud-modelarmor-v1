...
/// status.
public enum InvocationResult: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "INVOCATION_RESULT_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:InvocationResult/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "INVOCATION_RESULT_UNSPECIFIED": self = .unspecified
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:InvocationResult/unknownIntValue(_:)).
