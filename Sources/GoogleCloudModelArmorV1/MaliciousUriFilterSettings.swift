...
public struct MaliciousUriFilterSettings: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = MaliciousUriFilterSettings().with { $0.filterEnforcement = ... }
  /// ```
  ...
  public enum MaliciousUriFilterEnforcement: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "MALICIOUS_URI_FILTER_ENFORCEMENT_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:MaliciousUriFilterEnforcement/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "MALICIOUS_URI_FILTER_ENFORCEMENT_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:MaliciousUriFilterEnforcement/unknownIntValue(_:)).
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.modelarmor.v1.MaliciousUriFilterSettings"
  }
