# Google Cloud Client Libraries for Swift - Model Armor API
...
Add `swift-google-cloud-modelarmor-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-modelarmor-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudModelArmorV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudModelArmorV1 <target-name> --package swift-google-cloud-modelarmor-v1
```
